...
blob_fixups: blob_fixups_user_type = {
    ...
    ('odm/lib64/libEIS.so', 'odm/lib64/libEISLive.so', 'odm/lib64/libHIS.so', 'odm/lib64/libOPAlgoCamFaceBeautyCap.so', 'odm/lib64/libOGLManager.so', 'odm/lib64/libAncHumanSegFigureFusion.so', 'odm/lib64/libOPAlgoCamAiBeautyFaceRetouchCn.so'): blob_fixup()
